import{w as y,d as A,e as x,g as I,h as S,i as e,j as B,k as i,B as T,c as t,I as $,l as g,P as U,v as c,G as b,z as w,_ as V}from"./index-DpZ-JyLR.js";import{a as h}from"./c-auth-BnNd4lBs.js";import{a as N}from"./c-user-Byf-W5Gk.js";import{s as P,a as z}from"./function-call-bSfzxTzz.js";import"./index-CvsLU0J5.js";y(P);const j={class:"settings-page-wrapper w-full"},D={class:"box-border"},L={class:"content-container"},E={class:"group group-panel"},G={class:"cell"},M={class:"value"},R={class:"group group-panel"},q={class:"group group-panel"},F={class:"agreement-sheet"},H={class:"agreement-header"},J={class:"agreement-sheet"},K={class:"agreement-header"},O={class:"agreement-title"},Q={class:"agreement-body"},W=`欢迎使用遇见App（以下简称“本平台”）。本协议是您与本平台之间就使用服务所订立的协议。
...
感谢你使用遇见 App，祝你在这里遇见更好的关系与体验。`,Z=A({name:"MySettings",__name:"settings",setup(ss){const d=x(),u=c(""),n=c(!1),p=c("user"),r=c(!1),f=b(()=>p.value==="user"?"《遇见App用户协议》":"《遇见App隐私政策》"),m=l=>{p.value=l,n.value=!0},_=b(()=>p.value==="user"?W:X);(async()=>{const l=await N();u.value=(l==null?void 0:l.mobile)||""})();const k=()=>{w("已清除图片缓存")},C=()=>{z({title:"退出登录",message:"确定退出当前账号吗？",cancelButtonText:"取消",confirmButtonText:"确认",className:"logout-confirm-dialog"}).then(async()=>{await h({deviceId:localStorage.getItem("c_device_id")||"default_device"}),localStorage.removeItem("c_access_token"),localStorage.removeItem("c_refresh_token"),localStorage.removeItem("c_user_info"),w("已退出"),d.replace({name:"Login"})}).catch(()=>{})};return(l,s)=>{const a=$,v=U;return I(),S("div",j,[e("div",D,[e("div",L,[e("div",E,[e("div",G,[s[9]||(s[9]=e("span",{class:"label"},"手机号码",-1)),e("span",M,[B(i(u.value||"-")+" ",1),s[8]||(s[8]=e("span",{class:"text-xs opacity-50 ml-1"},"(仅自己可见)",-1))])]),e("div",{class:"cell clickable",onClick:s[0]||(s[0]=o=>T(d).push({name:"ChangePassword"}))},[s[10]||(s[10]=e("span",{class:"label"},"修改密码",-1)),t(a,{name:"arrow",class:"arrow-icon"})])]),e("div",R,[e("div",{class:"cell clickable",onClick:k},[s[11]||(s[11]=e("span",{class:"label"},"清除图片缓存",-1)),t(a,{name:"arrow",class:"arrow-icon"})])]),e("div",q,[e("div",{class:"cell clickable",onClick:s[1]||(s[1]=o=>r.value=!0)},[s[12]||(s[12]=e("span",{class:"label"},"关于我们",-1)),t(a,{name:"arrow",class:"arrow-icon"})]),e("div",{class:"cell clickable",onClick:s[2]||(s[2]=o=>m("user"))},[s[13]||(s[13]=e("span",{class:"label"},"用户协议",-1)),t(a,{name:"arrow",class:"arrow-icon"})]),e("div",{class:"cell clickable",onClick:s[3]||(s[3]=o=>m("privacy"))},[s[14]||(s[14]=e("span",{class:"label"},"隐私政策",-1)),t(a,{name:"arrow",class:"arrow-icon"})]),s[15]||(s[15]=e("div",{class:"cell"},[e("span",{class:"label"},"当前版本"),e("span",{class:"value"},"1.0.0.1")],-1))]),e("button",{class:"logout-btn",onClick:C},"退出登录")])]),t(v,{show:r.value,"onUpdate:show":s[5]||(s[5]=o=>r.value=o),position:"bottom",round:"",style:{height:"72vh",background:"#0b0b0b"}},{default:g(()=>[e("div",F,[e("div",H,[s[16]||(s[16]=e("span",{class:"agreement-title"},"关于遇见 App",-1)),t(a,{name:"cross",size:"20",class:"close-icon",onClick:s[4]||(s[4]=o=>r.value=!1)})]),s[17]||(s[17]=e("div",{class:"agreement-sub"},"让每一次相遇都更真实",-1)),e("div",{class:"agreement-body"},[e("pre",null,i(Y))])])]),_:1},8,["show"]),t(v,{show:n.value,"onUpdate:show":s[7]||(s[7]=o=>n.value=o),position:"bottom",round:"",style:{height:"78vh",background:"#0b0b0b"}},{default:g(()=>[e("div",J,[e("div",K,[e("span",O,i(f.value),1),t(a,{name:"cross",size:"20",class:"close-icon",onClick:s[6]||(s[6]=o=>n.value=!1)})]),s[18]||(s[18]=e("div",{class:"agreement-sub"},"更新日期：2026-03-27",-1)),e("div",Q,[e("pre",null,i(_.value),1)])])]),_:1},8,["show"])])}}}),rs=V(Z,[["__scopeId","data-v-71ce8fa7"]]);export{rs as default};
